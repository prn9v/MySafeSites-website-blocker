    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-sm relative">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground tracking-tighter">Welcome back</h1>
          <p className="text-sm text-muted-foreground mt-1">Sign in to your MySafeSites account</p>
        </div>
